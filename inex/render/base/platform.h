#ifndef INEX_RENDER_BASE_PLATFORM_H_INCLUDED
#	define INEX_RENDER_BASE_PLATFORM_H_INCLUDED
...
struct NOVTABLE platform {
	...
	//virtual	void				update_visual				( u32 id, inex::math::float4x4 const& transform, bool selected ) = 0;
	virtual	void				remove_visual				( u32 id ) = 0;
	//virtual	void				update_visual_vertex_buffer	( inex::render::visual_ptr v, vectora<buffer_fragment> const& fragments ) = 0;
	//virtual	void				update_visual_index_buffer	( inex::render::visual_ptr v, vectora<buffer_fragment> const& fragments ) = 0;
	//virtual	void				change_visual_shader		( inex::render::visual_ptr v, char const* shader, char const* texture ) = 0;
	...
	//virtual	void 				terrain_update_cell_buffer	( visual_ptr v, inex::vectora<buffer_fragment_NEW> const& fragments, float4x4 const& transform) = 0;
...
//protected:
	INEX_DECLARE_PURE_VIRTUAL_DESTRUCTOR( platform )
}; // class platform

} // namespace render
} // namespace inex

#endif // #ifndef INEX_RENDER_BASE_PLATFORM_H_INCLUDED