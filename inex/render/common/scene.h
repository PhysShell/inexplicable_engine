...
typedef std::vector< vertex_colored >		debug_vertices_type;
typedef std::vector< u16 >					debug_indices_type;
...
public:
			...
			void				flush					( std::function< void ( bool ) > const& on_draw_scene );
...
private:
	typedef std::vector< render::vertex_colored >					vertices_type;
	typedef std::vector< u16 >										indices_type;
