...
//#include <inex/render/common/sources/blender_light_mask.h>
//#include <inex/render/common/sources/blender_light_direct.h>
#include "stage.h"
...
public:
	...
	scene_render(bool render_test_scene) : stage( nullptr ) { }
	~scene_render() { }
