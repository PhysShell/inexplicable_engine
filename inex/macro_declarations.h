...
#   define SIZEOF_ARRAY( arrayName, elementType )   \
                                ( sizeof( arrayName ) / sizeof( elementType ) )
...
#	define INEX_DECLARE_PURE_VIRTUAL_DESTRUCTOR( name ) COMPILER_PURE_VIRTUAL_DESTRUCTOR( name )
